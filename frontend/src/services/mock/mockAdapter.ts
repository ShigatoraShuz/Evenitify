import { MOCK_EVENTS, MOCK_REQUIREMENTS, MOCK_VENDORS, MOCK_VENDOR_SERVICES, MOCK_BOOKINGS, MOCK_CONTRACTS, MOCK_NOTIFICATIONS, MOCK_ADMIN_BOOKINGS, MOCK_ADMIN_VENDORS, buildMockPortfolio } from './mockData'
